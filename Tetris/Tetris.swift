...
protocol TetrisDelegate{
    ...
    //falling shape has become part of the game board
    func gameShapeDidLand(tetris: Tetris)
    
    //falling shape has changed its location
    func gameShapeDidMove(tetris: Tetris)
    
    //falling shape has changed its location after being dropped
    func gameShapeDidDrop(tetris: Tetris)
    
    //Game has reached a new level
